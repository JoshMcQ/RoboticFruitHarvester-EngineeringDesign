...
OBSERVATION_POSES = [
    # --- existing 8 ---
    [357.4,   1.1, 231.7, 178.8,  0.3,   1.0],
    [289.3, -39.7, 428.6, 178.9, -13.4, -6.9],
    [245.1,  23.6, -45.0, -179.3,  6.3,  3.2],
    [256.0,-164.9, -57.5, 178.7,   0.1,  0.3],
    [384.3,  25.3, -23.8, -179.4,  6.0,  4.8],
    [416.6,-164.6, -57.5, 178.7,   0.1,  0.3],
    [557.3,  28.7, -17.2, -179.5, -5.2,  2.6],
    [566.9,-164.9, -57.5, 178.7,   0.1,  0.3],

    # --- your extra coverage poses ---
    [346.1, -33.0, 442.6, 176.3,  -9.5,   6.1],
...
EULER_EEF_TO_COLOR_OPT_INIT = [0.04658537628400468, -0.04366764963442021, 0.08775366937051188,
                               -0.10667948071366735, -0.045914354657809596, 1.521147732715267]
